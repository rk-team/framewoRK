...
class i18n {
	...
	private static
		$USER_CATALOGS_PATH = 'ressources/i18n/',
		$RK_CATALOGS_PATH = 'rk/i18n/',
	...
	/**
	 * Build cache files from all i18n files found in self::$RK_CATALOGS_PATH and self::$USER_CATALOGS_PATH folders
	 * @throws \rk\exception
	 */
	public static function makeCache() {
		$start = microtime(true);
		//Start building cache with framework extendable values
		self::_makeCache(self::$RK_CATALOGS_PATH);
		//Then extend with user ones
		self::_makeCache(self::$USER_CATALOGS_PATH, true);
